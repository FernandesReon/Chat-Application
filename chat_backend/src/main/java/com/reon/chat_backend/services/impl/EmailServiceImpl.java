...
import com.reon.chat_backend.services.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void resetPassword(String recipient, String name, String otp) {
        ...
        message.setFrom(emailSender);
        message.setTo(recipient);
        message.setSubject("Reset Your ChatSphere Password");
    ...
    public void passwordReset(String recipient, String name) {
        ...
        message.setFrom(emailSender);
        message.setTo(recipient);
        message.setSubject("Your ChatSphere Password Has Been Reset");
